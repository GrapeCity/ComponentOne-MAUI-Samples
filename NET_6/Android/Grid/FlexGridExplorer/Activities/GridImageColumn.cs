...
namespace FlexGridExplorer
{
    public class GridImageColumn : GridColumn
    {
        ...
        protected override void PrepareCell(GridCellType cellType, GridRow row, GridCellView cell, C1Thickness internalBorders)
        {
            base.PrepareCell(cellType, row, cell, internalBorders);
