    ...
    public class AxisBreakHelper
    {
        ...
        class AxisBreak
        {
            ...
            void DrawBreakArea(IRenderEngine engine, double x1, double y1, double x2, double y2, bool rotated = false)
            {
                ...
                engine.SetFill( App.Current?.RequestedTheme == AppTheme.Dark ? Colors.Black : Colors.White);
                ...
                engine.SetStroke(App.Current?.RequestedTheme == AppTheme.Dark ? Colors.White : Colors.Black);
